...
proměnná $\textit{Novostavba}$ vychazí statisticky signifikantní (i na 1% hladinně) a nabývá hodnoty `r spatial.err$coefficients %>% tail(1)`, tedy předpokládáme, že pokud se jedná o novostavbu bude cenna vyšší zhruba o `r 100*spatial.err$coefficients %>% tail(1)` %.
...
moran.test(spatial.err$residuals, W)
```
